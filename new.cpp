...
void iDraw()
{
	...
	if (flag==2)
	{
		iShowBMP(0,0,"jung.bmp");
		iSetColor(0, 255, 10);
		iShowBMP2(120,280,"wood.bmp",0);
		iShowBMP2(120,220,"wood.bmp",0);
		iShowBMP2(120,160,"wood.bmp",0);
		iSetColor(0, 0,0 );
	...
	if(flag==3 )
	{
		...
		if(lvl==1) iShowBMP(0,0,"jungle12.bmp");
		if(lvl==2) iShowBMP(0,0,"lvl2.bmp");
		if(lvl==2) iShowBMP2(700,0,"tree.bmp",0);
		if(lvl==3) iShowBMP(0,0,"last.bmp");
		//if(lvl==4) iShowBMP(0,0,"lvl4.bmp");
		iShowBMP2(ball_x,ball_y,"stone.bmp",0);
		if(chance==3) 
		{
			iShowBMP2(20,400,"stone.bmp",0);
			iShowBMP2(60,400,"stone.bmp",0);
			iShowBMP2(100,400,"stone.bmp",0);
		}
		if(chance==2) 
		{
			iShowBMP2(20,400,"stone.bmp",0);
		...
		iShowBMP2(0,0,"canon1.bmp",0);
		iShowBMP2(200,430,"speed.bmp",0);
		...
		if(lvl==3)
			{
				iShowBMP2(435,0,"rok.bmp",0);
				//iShowBMP2(827,0,"box.bmp",0*65536+255*256+0);
		}
		
		if(lvl==1) iShowBMP2(512+256+15,128,"obj.bmp",0);
		if(lvl==2) iShowBMP2(512+256+64+32,128+128,"monkey.bmp",0);
		if(lvl==3) iShowBMP2(663,64,"rih.bmp",0);
		//iSetColor(0,255,0);
		iShowBMP2(700,430,"wood.bmp",0);
		iSetColor(0,0,0);
	    iText(740,458,str);
	...
	if(flag==4)
	{
		...
		if(lvl==1) iShowBMP2(512+256+15,128,"ddd.bmp",0);
		if(lvl==2) iShowBMP2(512+256+64+32,128+128,"ddm.bmp",0);
		if(lvl==3) iShowBMP2(663,64,"dr.bmp",0);
		//iShowBMP2(512+256,128,"15.bmp",0*65536+255*256+0);
		iSetColor(0,255,0);
		iShowBMP2(720,435,"wood.bmp",0);
		iSetColor(0,0,0);
		iText(740,458,str);
		iSetColor(0,255,0);
		iShowBMP2(500,435,"wood.bmp",0);
		iSetColor(0,0,0);
		iText(520,458,"PLAY AGAIN");
		iSetColor(0,255,0);
		iShowBMP2(300,435,"wood.bmp",0);
		iSetColor(0,0,0);
		iText(320,458,"NEXT LEVEL");
		iSetColor(0,255,0);
		iShowBMP2(870,435,"wood.bmp",0);
		iSetColor(0,0,0);
		iText(890,458,"EXIT");
		iSetColor(0,210,0);
		iFilledRectangle(0,450,150,32);
	...
	if(flag==5)
	{
		...
		if(lvl==1) iShowBMP(0,0,"jungle12.bmp");
		if(lvl==2) iShowBMP(0,0,"lvl2.bmp");
		if(lvl==2) iShowBMP2(894,0,"tree.bmp",0);
		if(lvl==3) iShowBMP(0,0,"last.bmp");
		//iShowBMP2(ball_x,ball_y,"18.bmp",0*65536+255*256+0);
		iShowBMP2(0,0,"canon1.bmp",0);
	...
	if(flag==6)
	{
		...
		iShowBMP(0,0,"jung.bmp");
		//iSetColor(255,0,0);
		iShowBMP2(400,380,"wood.bmp",0);
		iSetColor(0,0,255);
		iText(420,408,"GAME OVER");
		//iSetColor(255,0,0);
		iShowBMP2(400,330,"wood.bmp",0);
		iSetColor(0,0,255);
	...
	if(flag==10){
		...
		iSetColor(0,0,0);
		iFilledRectangle(410,390,150,32);
		iSetColor(255,2,2);
		...
		for(i=0;i<4;i++){
			...
			iSetColor(0,255,0);
			iFilledRectangle(x,y-10,150,32);
			iFilledRectangle(x+180,y-10,50,32);
			iSetColor(0,0,0);
			iText(x,y,name[i]);
			iText(x+200,y,scr[i]);
			y=y-50;
	...
	if(high==1){
		...
		iSetColor(0,0,0);
		iFilledRectangle(380,250,150,32);
		iSetColor(255,2,2);
		iText(384,267,"INPUT YOUR NAME");
	...
	iSetColor(0, 0, 0);
	iText(100, 10, "Press p for pause, r for resume, END for exit,Up key for stop/play music.");
...
int main()
{
	...
	iInitialize(1024, 512, "Happy Hunting");
